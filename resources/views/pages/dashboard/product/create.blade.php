                    ...
                    <div class="px-4 py-5 bg-white sm:p-6 rounded shadow-lg">
                        <div class="flex flex-wrap -mx-3 ">
                            <div class="w-full px-3 mb-6">
                                ...
                                <input type="text" placeholder="Product Name" value="{{ old('title') }}" name="title" class="block w-full bg-gray-700 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-pink-500">
                            </div>
                        </div>
                        <div class="flex flex-wrap -mx-3">
                            <div class="w-full px-3 mb-6">
